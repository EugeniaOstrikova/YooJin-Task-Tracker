...
function StageColumn({
  ...
  const { groups, saveGroup, removeGroup } = useTaskGroups(
    stage.id === "pool" ? null : stage.id
  );
  ...
  return (
    <div
      ref={setNodeRef}
      className={`stage-col${isOver ? " stage-col--over" : ""}`}
    >
    ...
    <div style={{ padding: "20px 20px 40px" }}>
      ...
      >
        <div style={{ flex: 1 }}>
          ...
          {goal.deadline && (
            <div
              style={{ fontSize: 12, color: "var(--c-dim)", marginBottom: 8 }}
            >
          ...
          {goal.motivation && (
            <div
              style={{ fontSize: 13, color: "var(--c-mid)", marginBottom: 6 }}
            >
