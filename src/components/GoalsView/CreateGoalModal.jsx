      ...
      >
        ...
        {step === 1 && (
          <>
            ...
            <div className="field">
              <label className="field-label">
                Success criteria — how will I know I achieved it?
              </label>
              <textarea
                className="textarea"
                rows={2}
        ...
        {step === 2 && (
          <>
            <p
              style={{ fontSize: 13, color: "var(--c-mid)", marginBottom: 14 }}
            >
              Break your goal into stages. You can add tasks to each stage
              later.
            </p>
